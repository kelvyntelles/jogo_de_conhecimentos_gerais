  ...
  <div>
    ...
    <template v-if="this.question">
      ...
      <section v-if="this.answerSubmitted" class="result">
        <h4 v-if="this.chosenAnswer == this.correctAnswer"> &#9989; Você acertou! </h4>
        <h4 v-else> &#10060; Você errou! </h4>
        <button @click="this.getNewQuestion()" class="send" type="buttom">Next question</button>
      </section>
    </template>
  </div>
</template>
